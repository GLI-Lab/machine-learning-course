...
The public doctests are intentionally small and deterministic so you can quickly sanity-check your implementation. They use a simple 2D dataset of $N = 4$ points lying on the unit circle, with $Q = 2$ query points slightly inside it:
