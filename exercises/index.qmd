...
All labs are designed to run in the `pixi` Python environment provided for this course. If you have not set it up yet, follow the setup instructions in the course repository before your first lab session.

The core libraries used across labs are listed below. You do not need to install them separately; they are all included in the course environment.

- `numpy`: array operations and linear algebra
- `matplotlib`: visualization
- `torch` and `torchvision`: deep learning (from Unit 4 onward)
- `sklearn`: evaluation utilities and datasets

::: {.callout-warning}
## Google Colab Users

If you are running labs on Google Colab, click the Colab badge at the top of each notebook to open it directly. Colab already has most packages installed, but you may need to run `!pip install` for any course-specific utilities. Check the first cell of each notebook for Colab-specific setup instructions.
::: -->
